...
### 2-11. 7주차 DP
  ...
  - DP의 구성요소: 기저사례, 점화식(메모이제이션), 로직, 초기화
    - 풀이 방법: 바텀업, 탑다운
      - 바텀업 방식으로 푸는 것이 점화식 유도 방식을 말하고 조금 더 쉬운 풀이일듯함

  - 기본 문제
    - [boj2240](./4_7주차/boj2240.cpp) <<-- 내일 풀어보기
    - [boj15989](./4_7주차/boj15989.cpp) <<-- 혼자 풀기 실패.. 뭔가 이상하게 접근이되었음 <<-- 내일 풀어보기
    - [boj2748](./4_7주차/boj2748.cpp) <<-- 내일 풀어보기
