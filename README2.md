...
#### 백준풀기(7주차)
  ...
  --- 
  - (4/11 에서 pause하고 4/15 월요일부터 강의 재개, )
    - 7주차 문제 풀다가 목요일부터는 프로그래머스 문제만 풀기: 시험준비
      - 프로그래머스 문제 반복 풀기가 제일 날 듯 함 -> 일요일 까지 프로그래머스만 풀기
      - 시험 사전에 환경 체크하고 (v,토요일gogo)
    - 인프런 강의 중 DP 강의 부분 듣고 하는 것도 도움이 될 듯 함(kaist)
      - 특히, DP문제는 풀어본 것을 반복해서 풀어보는 것이 크게 도움이 될 듯 함
  --- 
