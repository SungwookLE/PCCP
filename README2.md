...
### 2-6. 히든퀘스트(1)
  - 쉬운 문제를 빠르게 푸는 연습을 많이 하자
    - https://www.acmicpc.net/step 의 16단계 까지 빠르게
      - 5단계인 `문자열` 부터 풀기 
      - 9단계인 `약수, 배수와 소수` 부터 풀기
      - 14단계인 `집합과 맵` 부터 풀기 ~ 16단계 까지 풀기
      - 15단계인 `약수, 배수와 소수2` 부터 풀기 ~ 16단계 까지 풀기 
      - 16단계인 `스텍, 덱, 큐` 부터 풀기 ~ 16단계 까지 풀기 
        - 2문제 못 풀어서 남았음 (3/7)
